      ...
      <div className='relative z-10 w-full max-w-lg px-6'>
        <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-lg shadow-2xl p-8 overflow-y-auto ">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            className={`bg-purple-950 w-full text-white rounded-sm p-2 px-3  mt-3 font-medium shadow-2xl flex items-center justify-center gap-2  ${!isCreatingAccount ? "hover:bg-purple-700 cursor-pointer " : "opacity-80 cursor-not-allowed" }`}>
              { isCreatingAccount ? ( <>
